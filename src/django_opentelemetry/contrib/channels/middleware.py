...
class ChannelScope(TypedDict):
    """ASGI scope for Django Channels."""

    type: Literal["channel"]
    channel: str


Scope = DefaultScope | ChannelScope


def _is_channel_scope(scope: DefaultScope) -> TypeGuard[ChannelScope]:
    """Check if the ASGI scope is a ChannelScope."""
    return scope.get("type") == "channel"
